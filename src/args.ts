...
export function getArgs() {
  return yargs(hideBin(process.argv))
    ...
    .command('install <nodeVersion>', 'Install a specific Node.js version using nvm', (yargs) => {
    ...
    .command('use <nodeVersion>', 'Switch to a specific Node.js version using nvm', (yargs) => {
      yargs.positional('nodeVersion', {
